...
type StdClientErrorHandler struct {
}

func (e StdClientErrorHandler) CheckResponse(response *http.Response) (error error, fatal bool) {
	switch {
...
func (e StdClientErrorHandler) CheckDownloadedFileForErrors(writtenSize int64, responseHeader http.Header) error {
...
func (e StdClientErrorHandler) IsFatalError(_ error) bool {
	return false
}
