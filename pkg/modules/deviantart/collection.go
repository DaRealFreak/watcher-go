...
// this is a special case since the API won't return the "All" folder and we can't retrieve the folder ID
// with the Eclipse theme which is enforced for new users....
func (m *deviantArt) parseAllCollections(username string) error {
	return nil
}
